...
local Config = {
    ...
    ServiceId       = 9661, -- Your PlatoBoost Service ID
    PlatoSecret     = "33c4eb06-e149-43fd-a328-b042251cccc4", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "ferrocupine", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/ZuriHubV2/Tesxcz/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    HubName         = "Murder Mystery 2 Script", -- The main title shown at the top of the GUI
    HubDescription  = "Fast Key System" -- The text shown below the title
}
